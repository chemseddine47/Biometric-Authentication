...
**⚠️ Privacy Note:** Due to strict privacy agreements signed by the participants, the **raw video files cannot be made public**. However, the code in this repository is fully functional and can be used to extract your own datasets or the anonymized image features if provided.
